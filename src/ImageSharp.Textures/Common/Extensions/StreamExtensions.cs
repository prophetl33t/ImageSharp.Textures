...
namespace SixLabors.ImageSharp.Textures.Common.Extensions
{
    ...
    internal static class StreamExtensions
    {
        ...
        public static void Read(this Stream stream, IMemoryOwner<byte> buffer) => stream.Read(buffer.Memory.Span);

        public static void Write(this Stream stream, IMemoryOwner<byte> buffer) => stream.Write(buffer.Memory.Span);
